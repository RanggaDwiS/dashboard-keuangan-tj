...
# ==========================================
# FUNGSI KOMPRESI DATA (SISTEM SHARING)
# ==========================================
def encode_df(df):
...
# ==========================================
# 2. RENDER DASHBOARD (LOGIKA ASLI)
# ==========================================
def render_full_dashboard(df):
    ...
    with c_kanan:
        ...
        fig_combo.add_trace(go.Bar(x=df_kat['Waktu'], y=df_kat['Total Pendapatan'], name='Pendapatan', marker_color='#8ECAE6', text=df_kat['Total Pendapatan'], texttemplate='%{text:,.0f}', textposition='inside'), secondary_y=False)
